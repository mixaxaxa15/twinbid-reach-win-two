      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-fade-in">
            ...
            <span className="text-sm text-muted-foreground">Рекламная платформа нового поколения</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight animate-fade-in">
            <span className="text-foreground">TwinBid — </span>
            <span className="gradient-text">рекламная платформа-агрегатор</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed animate-fade-in">
            Объединяет трафик сотен рекламных сетей. Одна регистрация — и вы получаете доступ 
            к инвентарю более чем <span className="text-foreground font-semibold">1 млн сайтов</span> через 
            единый кабинет закупки, аналитики и оптимизации.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-12 max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Рекламных сетей</div>
            </div>

...
const copy = {
  ...
  fr: {
    title: "Calculateur de trafic",
    subtitle: "Découvrez combien d’impressions étaient disponibles pour le ciblage sélectionné lors de la dernière journée complète.",
    selectCampaign: "Sélectionnez une campagne",
    selectCampaignDesc: "Le ciblage de la campagne sera renseigné automatiquement. Sans campagne, vous pouvez vérifier n’importe quel ensemble de paramètres.",
    free: "Calcul libre",
    freeDesc: "Configurer le ciblage manuellement",
    otherCampaign: "Rechercher une autre campagne",
    parameters: "Paramètres du calcul",
    campaignParameters: "Les paramètres proviennent de la campagne sélectionnée et peuvent être ajustés pour le calcul.",
    allTraffic: "Une sélection vide correspond à tout le trafic disponible.",
    format: "Format",
    ...
    sitesPlaceholder: "12345,abdjhx",
    sitesFormatError: "Saisissez les ID sans espaces, séparés par des virgules",
    getData: "Obtenir les données",
    placeholderTitle: "Le volume disponible apparaîtra ici",
    placeholderDesc: "Choisissez un ciblage pour obtenir le volume d’impressions disponible lors de la dernière journée complète.",
    unavailable: "Données indisponibles",
    unavailableDesc: "Impossible de charger les données. Vérifiez l’intégration POST /api/calculator.",
    potentialImpressions: "Impressions disponibles",
    targetingHint: "pour le ciblage sélectionné",
    actualImpressions: "Impressions réelles",
    sameDay: "pour la même journée complète",
    statsHint: "selon les statistiques de la campagne",
    noData: "aucune donnée pour cette date",
    share: "Part obtenue",
    shareHint: "des impressions disponibles",
    currentBid: "Enchère actuelle",
    moreTraffic: "Vous souhaitez recevoir davantage de trafic ?",
    bidDesc: "Augmentez l’enchère de la campagne sélectionnée. Seul son montant peut être modifié ici ; le modèle de paiement reste inchangé.",
    newBid: "Nouvelle enchère, USD",
    fixedType: "type fixe",
    save: "Enregistrer",
    bidPositive: "Saisissez une enchère supérieure à zéro",
    bidBelowMin: "L’enchère ne peut pas être inférieure à {value}",
    bidAboveMax: "L’enchère ne peut pas être supérieure à {value}",
    bidSaved: "Enchère de la campagne mise à jour",
    bidError: "Impossible de modifier l’enchère",
    all: "Tous",
    include: "Inclure",
    exclude: "Exclure",
    excluded: "exclus",

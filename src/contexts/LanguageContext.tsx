...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "settings.appearanceDescription": { ru: "Выберите тему кабинета. Настройка сохранится на этом устройстве.", en: "Choose the dashboard theme. The setting will be saved on this device." },

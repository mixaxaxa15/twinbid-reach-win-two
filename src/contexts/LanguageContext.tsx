...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "create.description": { ru: "Описание (опционально)", en: "Description (optional)" },
  "create.descPlaceholder": { ru: "Опишите цели кампании...", en: "Describe campaign goals..." },
  ...
  "budget.trafficCommon": { ru: "Трафик, очищенный от ботов нашей внутренней системой", en: "Traffic cleaned from bots by our internal system" },
  "budget.trafficHigh": { ru: "Трафик с самыми жёсткими фильтрами на стороне поставщиков + наши жёсткие фильтры", en: "Traffic with the strictest filters on the supplier side + our strict filters" },
  "budget.trafficUltra": { ru: "Самый высококонвертящий сегмент с лучшими результатами у других рекламодателей, отфильтрованный поставщиками, нами и проверенный независимыми чекерами", en: "Highest-converting segment with best results from other advertisers, filtered by suppliers, us, and verified by independent checkers" },

...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "targeting.vpnTraffic": { ru: "VPN-трафик", en: "VPN traffic" },
  "targeting.vpnTrafficEnabled": { ru: "Разрешён для этой кампании", en: "Allowed for this campaign" },
  "targeting.vpnTrafficDisabled": { ru: "Исключён из этой кампании", en: "Excluded from this campaign" },

...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "stats.cleaner.minimumSpend": { ru: "Минимальный расход без конверсий, USD", en: "Minimum spend without conversions, USD" },
  "stats.cleaner.selectNoConversions": { ru: "Выбрать без конверсий", en: "Select without conversions" },
  ...
  "stats.cleaner.noMatches": { ru: "Источники без конверсий с таким расходом не найдены", en: "No sources without conversions match this spend threshold" },

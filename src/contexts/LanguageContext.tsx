...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "create.mismatchConfirmBody": { ru: "У некоторых креативов размер картинки не совпадает с требуемым. Сохранить как есть или отредактировать?", en: "Some creatives have images not matching the required size. Save as is or edit?" },
  "create.mismatchSaveAnyway": { ru: "Сохранить как есть", en: "Save as is" },
  "create.mismatchGoEdit": { ru: "Отредактировать", en: "Edit" },

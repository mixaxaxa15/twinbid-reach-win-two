...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "create.uploadBannerMedia": { ru: "Загрузить изображение или MP4", en: "Upload image or MP4" },
  ...
  "create.imageFormatHint": { ru: "PNG, JPG или GIF, до 64 МБ", en: "PNG, JPG or GIF, up to 64 MB" },
  "create.bannerMediaFormatHint": { ru: "PNG, JPG или GIF до 64 МБ; MP4 до 10 МБ", en: "PNG, JPG or GIF up to 64 MB; MP4 up to 10 MB" },
  "create.imageSizeError": { ru: "Размер изображения не должен превышать 64 МБ", en: "Image size must not exceed 64 MB" },
